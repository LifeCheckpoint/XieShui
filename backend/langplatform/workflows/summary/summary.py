...
def create_summary_workflow():
    # 提示词模板
    feature_prompt = PromptTemplate.from_file(Path(__file__).parent / "subject_features.txt", encoding="utf-8") # 有字段 "feature"
    summary_prompt = PromptTemplate.from_file(Path(__file__).parent / "summary_text.txt", encoding="utf-8") # 有字段 "text" 和 "feature"
